namespace Andrei15193.Kepler.Compiler.Regex
{
    ...
    public class RegexLanguage<TCode> : Compiler<TCode>.ILanguage
        where TCode : struct
    {
        ...
        public RegexLanguage()
        {
            ...
            var enclosures = new Dictionary<AtomAttribute.EnclosureType, IDictionary<Compiler<TCode>.Enclosure, TCode>>();
            ...
            enclosures.Add(AtomAttribute.EnclosureType.Comment, new Dictionary<Compiler<TCode>.Enclosure, TCode>());
            enclosures.Add(AtomAttribute.EnclosureType.Constant, new Dictionary<Compiler<TCode>.Enclosure, TCode>());
            ...
            _enclosedConstants = new ReadOnlyDictionary<Compiler<TCode>.Enclosure, TCode>(enclosures[AtomAttribute.EnclosureType.Constant]);
            _enclosedComments = new ReadOnlyDictionary<Compiler<TCode>.Enclosure, TCode>(enclosures[AtomAttribute.EnclosureType.Comment]);
        }
        ...
        public IEnumerable<Compiler<TCode>.Enclosure> Enclosures
        {
            get
            {
        ...
        private readonly IReadOnlyDictionary<Compiler<TCode>.Enclosure, TCode> _enclosedConstants;
        private readonly IReadOnlyDictionary<Compiler<TCode>.Enclosure, TCode> _enclosedComments;
    }
}
