...
{
    public sealed class ClosingSquareParenthesisSymbol
        : TerminalSymbol
    {
        public ClosingSquareParenthesisSymbol(ScannedAtom<Lexicon> atom, ILanguage<Lexicon> language)
            : base(SymbolNodeType.ClosingSquareParenthesis)
        {
            if (atom != null)
                if (language != null)
                    if (atom.Code == Lexicon.ClosingSquareParenthesis)
                    {
