...
{
    public sealed class OpeningSquareParenthesisSymbol
        : TerminalSymbol
    {
        public OpeningSquareParenthesisSymbol(ScannedAtom<Lexicon> atom, ILanguage<Lexicon> language)
            : base(SymbolNodeType.OpeningSquareParenthesis)
        {
            if (atom != null)
                if (language != null)
                    if (atom.Code == Lexicon.OpeningSquareParenthesis)
                    {
